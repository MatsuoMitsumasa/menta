...

{
    package MENTA::TemplateLoader::Instance;
    no strict 'refs';
    for my $meth (qw/escape_html unescape_html raw_string config render param env cookie mobile_agent uri_for static_file_path docroot AUTOLOAD redirect current_url wants_json/) {
